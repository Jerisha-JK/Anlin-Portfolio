  ...
  return (
    <div ref={ref} className={`mb-20 reveal ${visible ? 'visible' : ''}`}>
      <div className="flex items-center gap-4 mb-4">
        {num && <span className="font-display text-5xl font-bold text-sky-400/20 leading-none">{num}</span>}
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid sm:grid-cols-2 gap-5">
        <div className="space-y-1.5">
          ...
          <input type="text" name="name" value={form.name} onChange={handleChange} required placeholder="Your Name" className={inputCls} />
        </div>
        <div className="space-y-1.5">
          ...
          <input type="email" name="email" value={form.email} onChange={handleChange} required placeholder="Your Email" className={inputCls} />
        </div>
      </div>
      <div className="grid sm:grid-cols-2 gap-5">
        <div className="space-y-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <input type="text" name="company" value={form.company} onChange={handleChange} placeholder="Company / Organization Name (optional)" className={inputCls} />
        </div>
      </div>
      <div className="space-y-1.5">
      ...
      <section id="about" className="relative min-h-screen w-full hero-bg flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24 pt-28 pb-16">
          <div className="hero-stagger flex flex-col items-start gap-7 max-w-4xl">
            ...
            <h1 className="font-display font-bold text-white leading-[0.95] text-[clamp(3.5rem,10vw,7rem)] whitespace-nowrap">
